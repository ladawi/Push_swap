...
/*   Updated: 2021/09/14 17:28:23 by ladawi           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	print_list(t_push_swap *push_swap, t_chain *node)
{
	...
	if (node->next != NULL)
		print_list(push_swap, node->next);
	return ;
}
...
int			main(int ac, char **av)
{
	...
	push_swap.list_a = ft_calloc(sizeof(t_chain), 1);
	push_swap.list_b = ft_calloc(sizeof(t_chain), 1);
	if (!(push_swap.tab_nb) || !(push_swap.list_a) || !(push_swap.list_b))
		return (-1);
	...
	print_list(&push_swap, push_swap.list_a);
	printf("------------------------\n");
	// rev_rotate_a(&push_swap);
	push_b(&push_swap);
	push_b(&push_swap);
	// print_list(&push_swap, push_swap.list_a);
	print_list(&push_swap, push_swap.list_a);
	printf("______________________\n");
	print_list(&push_swap, push_swap.list_b);
	printf("------------------------\n");
	return (0);
}